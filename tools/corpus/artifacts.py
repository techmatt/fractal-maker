...
RELOCATED_PREFIXES = (
    ...
    # prefix is not kept "just in case" — a registered prefix for a family nothing writes is a
    # relocation rule that can only ever mislead, and re-registering costs one line if the
    # decision reverses (storage_classes.md rule 5: register BEFORE the first write).
