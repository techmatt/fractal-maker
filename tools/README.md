...
| `v10/` | 10 | **The one rollback rung** (live 2026-08-02 → 2026-08-08). v9's cache extended with 1,267 appended maneuver-view locations; `build_manifest.py`/`build_plan.py`/`render_cache.py`/`verify_cache_alignment.py`, `prereg.py` + `eval_v10.py`, `diagnose_selection.py`, `derive_t_good_v10.py`. Its `test_v10_flip.py` moved to `scoring/test_flip_coherence.py` at the v11 flip — it was written against `ACTIVE_VERSION`, so it was never v10's test, only v10's file. | rollback rung | — |
